    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="fs-2 text-center page-title">Category</div>
                <div class="card-body text-end">
                    <a href="category_add.php" type="button" class="btn btn-outline-success btn-sm">
                                    ...
                                    foreach($result as $rows){
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-outline-danger btn-sm" href="category_delete.php?delete_id=<?= $category_id ?>">
